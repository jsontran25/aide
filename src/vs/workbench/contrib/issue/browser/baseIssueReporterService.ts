...
export class BaseIssueReporterService extends Disposable {
	...
	public setSourceOptions(): void {
		...
		sourceSelect.append(this.makeOption(IssueSource.VSCode, localize('vscode', "AIDE"), false));
		sourceSelect.append(this.makeOption(IssueSource.Extension, localize('extension', "A AIDE extension"), false));
	...
	public async renderBlocks(): Promise<void> {
		...
		if (selectedExtension && this.nonGitHubIssueUrl) {
			...
			reset(descriptionTitle, localize('handlesIssuesElsewhere', "This extension handles issues outside of AIDE"));
