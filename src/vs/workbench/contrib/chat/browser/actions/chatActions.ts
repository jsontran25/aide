...
export function registerChatActions() {
	...
	registerAction2(class UpdateInstructionsAction extends Action2 {
		...
		async run(accessor: ServicesAccessor): Promise<void> {
			...
			const query = `Analyze this codebase to generate or update \`.github/aide-instructions.md\` for guiding AI coding agents.
...
Source existing AI conventions from \`**/{.github/aide-instructions.md,AGENT.md,AGENTS.md,CLAUDE.md,.cursorrules,.windsurfrules,.clinerules,.cursor/rules/**,.windsurf/rules/**,.clinerules/**,README.md}\` (do one glob search).

Guidelines (read more at https://aka.ms/vscode-instructions-docs):
- If \`.github/aide-instructions.md\` exists, merge intelligently - preserve valuable content while updating outdated sections
...
Update \`.github/aide-instructions.md\` for the user, then ask for feedback on any unclear or incomplete sections to iterate.`;
