	...
	definitions: {
		...
		taskDescription: {
			...
			properties: {
				...
				promptOnClose: {
					type: 'boolean',
					description: nls.localize('JsonSchema.tasks.promptOnClose', 'Whether the user is prompted when AIDE closes with a running task.'),
					default: false
				},
				isBuildCommand: {
					type: 'boolean',
		...
		taskRunnerConfiguration: {
			...
			properties: {
				...
				promptOnClose: {
					type: 'boolean',
					description: nls.localize('JsonSchema.promptOnClose', 'Whether the user is prompted when AIDE closes with a running background task.'),
					default: false
				},
				echoCommand: {
					type: 'boolean',
