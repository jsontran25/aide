						...
						translations: {
							...
							items: {
								...
								properties: {
									id: {
										type: 'string',
										description: localize('vscode.extension.contributes.localizations.translations.id', "Id of the core editor or an extension for which this translation is contributed to. Id of the core editor is always `vscode` and an extension id should be in format `publisherId.extensionName`."),
