...
export class ConfigureDisplayLanguageAction extends Action2 {
	...
	constructor() {
		super({
			...
			metadata: {
				description: localize2('configureLocaleDescription', "Changes the locale of AIDE based on installed language packs. Common languages include French, Chinese, Spanish, Japanese, German, Korean, and more.")
			}
		});
	}
