...
const DEFAULT_CONTENT: string = [
	`// ${nls.localize('displayLanguage', 'Defines the keyboard layout used in AIDE in the browser environment.')}`,
	`// ${nls.localize('doc', 'Open AIDE and run "Developer: Inspect Key Mappings (JSON)" from Command Palette.')}`,
	``,
